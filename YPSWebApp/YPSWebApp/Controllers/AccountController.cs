...
namespace YPSWebApp.Controllers
{
    ...
    public class AccountController : AuthBaseController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    {
                        return RedirectToAction("Confirm", new { email = model.Email.ToString() });
                    ...
                    //return View("~/Views/Overview/Index");
        ...
        public ActionResult Confirm(string Email)
        {
            ...
            if (user != null)
            {
                string code = UserManager.GenerateEmailConfirmationToken(user.Id.ToString());
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new User { UserName = model.Email, Email = model.Email,Firstname=model.Firstname,Surname=model.Surname };
