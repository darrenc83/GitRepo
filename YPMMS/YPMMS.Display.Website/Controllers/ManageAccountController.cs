...
using YPMMS.Display.Website.Models.ManageAccount;

namespace YPMMS.Display.Website.Controllers
{
    /// <summary>
    /// ASP.NET Identity boilerplate controller for managing user accounts
    /// </summary>
    public class ManageAccountController : AuthBaseController
    {
        ...
        //
        // POST: /ManageAccount/RemovePhoneNumber
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        //
        // GET: /ManageAccount/ManageLogins
...
//            return new AccountController.ChallengeResult(provider, Url.Action("LinkLoginCallback", "ManageAccount"), User.Identity.GetUserId());
